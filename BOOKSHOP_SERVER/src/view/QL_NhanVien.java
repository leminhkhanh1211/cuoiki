...
public class QL_NhanVien extends JPanel{
	...
	public QL_NhanVien() {
		...
		scrollPane.setBounds(20, 341, 1194, 375);
		add(scrollPane);
		...
		tf_maNhanVien.setBounds(184, 103, 250, 29);
		add(tf_maNhanVien);
		...
		cb_chucVu.setBounds(635, 217, 250, 30);
		add(cb_chucVu);
		...
		bt_xuatDanhSach.setBounds(930, 103, 197, 45);
		...
		bt_themNhanVien.setBounds(930, 158, 197, 45);
		...
		bt_suaThongTin.setBounds(930, 213, 197, 45);
		...
		bt_xoaNhanVien.setBounds(930, 268, 197, 45);
